      ...
      <div className="vno-px-4 sm:vno-px-6 md:vno-px-8">
        <div className="vno-max-w-3xl vno-mx-auto vno-pb-28">
          <main>
            <article className="vno-relative vno-pt-10">
              ...
              <div className="vno-mt-6">
                <ul className="vno-flex vno-flex-wrap -vno-mx-5 -vno-mt-6 vno-text-sm vno-leading-6">
                  <li className="vno-flex vno-items-center vno-px-5 vno-mt-6 vno-font-medium vno-whitespace-nowrap">
                    {authorDetails.avatar && (
                      <Image
                        ...
                        className="vno-rounded-full vno-w-9 vno-h-9 vno-bg-slate-50 dark:vno-bg-slate-800"
                      />
                    )}
              ...
              <div className="vno-my-10 vno-flex vno-items-center vno-justify-between">
                <aside aria-label="Share social media">
                  <Link
                    ...
                    className="vno-inline-flex vno-items-center vno-px-3 vno-py-2 vno-mr-2 vno-text-xs vno-font-medium vno-text-gray-900 vno-no-underline vno-bg-white vno-border vno-border-gray-200 vno-rounded-lg focus:vno-outline-none hover:vno-bg-gray-100 hover:vno-text-gray-700 focus:vno-z-10 focus:vno-ring-4 focus:vno-ring-gray-200 dark:focus:vno-ring-gray-700 dark:vno-bg-gray-800 dark:vno-text-gray-400 dark:vno-border-gray-600 dark:hover:vno-text-white dark:hover:vno-bg-gray-700"
                  >
                    <svg
                      className="vno-w-4 vno-h-4 vno-mr-2"
                      fill="currentColor"
                      aria-hidden="true"
          ...
          >
            ...
            {(next || prev) && (
              <div className="vno-my-10 vno-text-slate-700 vno-font-semibold vno-flex vno-items-center dark:vno-text-slate-200">
                {prev && (
                  <Link
                    href={`/blog/${prev.slug}`}
                    className="vno-flex vno-mr-8 hover:vno-text-slate-900 dark:hover:vno-text-white"
                  >
                    <span
                      aria-hidden="true"
                      className="vno-mr-2"
                ...
                {next && (
                  <Link
                    href={`/blog/${next.slug}`}
                    className="vno-flex vno-ml-auto vno-text-right hover:vno-text-slate-900 dark:hover:vno-text-white"
                  >
                    {next.title}
                    <span
                      aria-hidden="true"
